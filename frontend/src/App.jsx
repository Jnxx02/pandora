...
const KelolaDokumentasi = lazy(() => import('./pages/admin/KelolaDokumentasi'));
...
function AdminHeader({ sidebarOpen, setSidebarOpen, sidebarCollapsed, setSidebarCollapsed }) {
  ...
  const adminNavLinks = [
    ...
    { to: '/admin/dokumentasi', label: 'Kelola Dokumentasi', icon: (
      <svg className="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="w-full bg-primary text-white pt-10 pb-4 px-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <a href="mailto:moncongloebulu.desa@gmail.com" className="underline hover:text-secondary transition-colors">moncongloebulu.desa@gmail.com</a>
          </div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <a href="https://www.tiktok.com/@pemdes.mloebulu" target="_blank" rel="noopener noreferrer" className="underline hover:text-secondary transition-colors">@pemdes.mloebulu</a>
          </div>
          <div className="flex items-center gap-2 mb-2">
            <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
            <a href="https://web.facebook.com/moncongloebulu.moncongloebulu" target="_blank" rel="noopener noreferrer" className="underline hover:text-secondary transition-colors">Pemdes Moncongloebulu</a>
          </div>
          <div className="flex items-center gap-2 mb-2">
            <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          <div className="flex items-start gap-2">
            ...
            <span>Tamalate, Jalan Poros Moncongloe Bulu - Daya Makassar, Desa Moncongloe Bulu, Kec. Moncongloe, Kab. Maros, Sulawesi Selatan 90564</span>
          </div>
        </div>
      </div>
