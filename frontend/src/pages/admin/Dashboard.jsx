    ...
    <div className="min-h-screen bg-neutral">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-lg border border-neutral/50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Recent Berita */}
          <div className="bg-white rounded-xl shadow-lg border border-neutral/50">
        ...
        {/* Quick Actions */}
        <div className="mt-8 bg-white rounded-xl shadow-lg border border-neutral/50">
          <div className="p-6 border-b border-neutral/100">
