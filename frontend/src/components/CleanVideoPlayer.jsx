...
const CleanVideoPlayer = ({ 
  ...
  return (
    <div className={`${className} aspect-w-16 aspect-h-9`}>
      <iframe
        src={`https://www.youtube.com/embed/${youtubeVideoId}?rel=0&modestbranding=1&showinfo=0&controls=1&disablekb=1&fs=1&iv_load_policy=3&cc_load_policy=0&color=white&theme=light&playsinline=1&origin=${window.location.origin}&enablejsapi=1`}
        title={title}
        frameBorder="0"
