...
const MinimalVideoEmbed = ({ 
  ...
  const renderVideo = () => {
    ...
    if (youtubeVideoId) {
      return (
        <iframe
          src={`https://www.youtube.com/embed/${youtubeVideoId}?rel=0&modestbranding=1&showinfo=0&controls=1&disablekb=1&fs=1&iv_load_policy=3&cc_load_policy=0`}
          title={title}
          frameBorder="0"
...
export default MinimalVideoEmbed; 